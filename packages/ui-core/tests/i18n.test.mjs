...
test("nenhuma mensagem ficou sem traduzir entre os catalogos", () => {
  ...
  const iguaisPorNatureza = new Set([
    ...
    // Simbolos e abreviacoes de unidade nao mudam de idioma.
    ...
    "shapeLibrary.unit.px",
    "orbit.unit.px",
    "orbit.unit.degrees",
    "orbit.unit.degreesPerSecond",
    "echo.unit.seconds",
    "fastEdit.unit.seconds",
    "fastEdit.unit.fps",
    "fastEdit.unit.px",
    "parallax.unit.px",
    "parallaxFull.unit.px",
    "animateKinetic.unit.degrees",
    "wave.unit.degrees",
    "animateKinetic.unit.percent",
    // "Rotation"/"Rotação" difere, mas grau e por cento nao.
    "animateKinetic.overshoot",
    "parallaxFull.unit.hertz",
    // "Zoom", "Amplitude" e "Hz" se escrevem igual nos dois idiomas.
    "parallaxFull.op.zoom",
    "parallaxFull.zoomLevel",
    "parallaxFull.amplitude",
    "effector.unit.px",
    "effector.unit.percent",
    "effector.unit.degrees",
    // Nomes iguais nos dois idiomas.
    "tool.effector.name",
    "effector.falloffCurve.linear",
    "cameraTransition.unit.px",
    "cameraTransition.unit.degrees",
    // Nomes iguais nos dois idiomas.
    "cameraTransition.amount",
    "cylinder.unit.px",
    ...
    "wave.mode",
    "tile.mode",
    // Nomes de eixo e do proprio efeito, iguais nos dois idiomas.
    "lookAt.axis.zPos",
    "lookAt.axis.zNeg",
    "lookAt.axis.xPos",
    "lookAt.axis.xNeg",
    "echo.operator",
    "fastEdit.frameRate",
    // "Amplitude" e "Interface" se escrevem igual nos dois idiomas.
    "inertial.amplitude",
    "settings.interface.title",
    // Nomes dos proprios idiomas, escritos como cada um se chama.
    "pt-BR",
    "en-US",
    // Nomes proprios de efeito, iguais nos dois idiomas — o mesmo motivo de
